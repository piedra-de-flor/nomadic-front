...
const DetailPlanCreateScreen = ({ navigation, route }: any) => {
  const { planId, planTitle, selectedDate: initialDate } = route.params || {};
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // TODO: API 호출
      // const response = await detailPlanService.createDetailPlan(detailPlan);
      ...
      setIsSubmitting(false);
      Alert.alert('오류', '세부 계획 생성 중 오류가 발생했습니다. 다시 시도해주세요.');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.planInfoSection}>
          ...
          <View style={styles.planCard}>
            ...
            <Text style={styles.planTitle}>{planTitle || '제주도 여행'}</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              placeholder="YYYY-MM-DD 형식으로 입력 (예: 2024-12-20)"
...
export default DetailPlanCreateScreen;
